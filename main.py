...
dict_summary = {"Number of subjects": length,"Number of subjects per region" : region_count, "Average BMI": dis_dict.average_bmi(),\
                "Average age": average_age, "Average cost":average_cost,"Difference between smoker/non-smoker": difference}
